...
var (
	...
	ErrAcceptanceReconciliationRequired = errors.New("task action binding: acceptance outcome requires reconciliation")
	...
	ErrUseTrustedLeaseMonitor           = errors.New("task action binding: use trusted lease monitor")
	ErrWrongCommitPath                  = errors.New("task action binding: transition requires a dedicated commit path")
)
