...
const (
	actionLifecycleSchemaURL   = "https://github.com/ToppyMicroServices/agents-secure-binding/schemas/action-lifecycle-v1.schema.json"
	taskActionBindingSchemaURL = "https://github.com/ToppyMicroServices/agents-secure-binding/schemas/task-action-binding-v1.schema.json"
	maxActionSchemaJSONBytes   = 1 << 20
)
...
func validateEmbeddedJSON(name string, schema *jsonschema.Schema, raw []byte) error {
	if err := strictjson.ValidateDocument(raw, maxActionSchemaJSONBytes); err != nil {
